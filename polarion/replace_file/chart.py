...
class Chart(object):
    ...
    def get_json(self):
        ...
        spec["basicChart"]["axis"] = list()
        dict_axis = dict()
        dict_axis["position"] = "BOTTOM_AXIS"
        dict_axis["title"] = "Tier Classification ==>/Day"
        dict_axis["titleTextPosition"] = dict({"horizontalAlignment": "CENTER"})
        spec["basicChart"]["axis"].append(dict_axis)

        spec["basicChart"]["headerCount"] = 1
        spec["titleTextPosition"] = dict()
